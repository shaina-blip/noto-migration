...
- **Elliott Blanchard** — package (Rachel Pauli's account) is labeled Bridge Program, but Shaina confirmed her actual sessions are booked as Launch Program. Package is mislabeled at the source — needs correcting in Noto/the billing system, not just here.
...
- **Ryan McCabe** — currently shown on a Jennifer McCabe / Launch Program package, but his actual sessions are College Launch work (lesson titles: "CL Essay", "CL #2", "CL #3", "CL #4"). Shaina doesn't see a College Launch invoice on file to reconcile against — needs tracking down.
